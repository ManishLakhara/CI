...
Route::group(['middleware' => ['admin']], function(){
    ...
    Route::get('story-published/{story}',[StoryController::class,'updateToPublished'])->name('story.published');
    Route::get('story-declined/{story}',[StoryController::class,'updateToDeclined'])->name('story.declined');
    Route::resource('story',StoryController::class)->only(['index','show','destroy']);
    Route::resource('missiontheme', MissionThemeController::class)->withTrashed();
    Route::resource('skill', MissionSkillController::class)->withTrashed();
    Route::resource('user', UserController::class)->withTrashed()->except('show');
...
Route::group(['middleware' => ['user']], function(){
    ...
    Route::get('edit-profile/{user}', [UserEditProfileController::class,'editProfile'])->name('edit-profile');
    Route::post('logout', [UserEditProfileController::class,'logout'])->name('logout');
    Route::get('mission-page/{mission}',[MissionDetailController::class,'main'])->name('mission-page');
